  ...
  const handleFaceLogin = async () => {
    ...
    try {
      ...
      setTimeout(async () => {
        ...
        // First send image to /extract-encoding route to extract face encoding
        ...
        // Send the extracted encoding to /verify-face
        const res = await axios.post('http://localhost:5001/verify-face', {
          known_encoding: encodingRes.data.encoding, // the cropped grayscale face
          unknown_encoding: imageData, // full base64 image string (e.g. "data:image/jpeg;base64,...")
          username: formData.username, // optional, if you use this for logging
        });
  ...
  return (
    <section className="bg-gray-950 py-24 px-4 text-white">
      <div className="container mx-auto max-w-xl">
        <SectionTitle title="Student Login" subtitle="Choose a login method" align="center" />

...
const ClientLogin = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Client logged in with credentials:', res.data);
  ...
  const handleFaceLogin = async () => {
    ...
    try {
      ...
      setTimeout(async () => {
        ...
        console.log('Client logged in with face:', res.data);
  ...
  return (
    <section className="bg-gray-950 py-24 px-4 text-white">
      <div className="container mx-auto max-w-xl">
        <SectionTitle title="Client Login" subtitle="Choose a login method" align="center" />

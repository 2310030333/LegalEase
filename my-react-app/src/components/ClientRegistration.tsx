  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.identityProof) {
        payload.append('identityProof', formData.identityProof); // Appending file for identity proof
      }
    ...
    <section className="bg-gradient-to-br from-gray-900 via-gray-950 to-black py-24 px-4 text-white min-h-screen">
      <div className="container mx-auto max-w-2xl">
        <SectionTitle
          ...
          subtitle="Provide your details and verify your identity to join."
          align="center"
        />
        ...
        >
          ...
          <div className="space-y-4">
            <label className="block text-sm text-gray-400 font-medium">Identity Proof (PDF or Image)</label>
            <input
              type="file"
              name="identityProof"
